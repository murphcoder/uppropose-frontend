      ...
      <div className="cookie-policy">
        ...
        <div className="policy-content">
          ...
          <p className="last-updated">
            <strong>Last updated October 01, 2025</strong>
          </p>
  
          <p>
            This Cookie Policy explains how Murphcoder Web Development LLC ("
            ...
            <a href="https://uppropose.com" target="_blank" rel="noopener noreferrer">
              https://uppropose.com
            </a>{" "}
          ...
          <p>
            Cookies set by the website owner (in this case, Murphcoder Web
            Development LLC) are called "first-party cookies." Cookies set by
          ...
          <p>
            ...
            <a href="mailto:murphcoder@gmail.com">murphcoder@gmail.com</a> or by
            post to:
          </p>
  
          <div className="contact-info">
            <p>Murphcoder Web Development LLC</p>
            <p>137 N Oak Park Ave.</p>
            <p>Oak Park, IL 60301</p>
            <p>United States</p>
            <p>Phone: (+1)+1-847-238-1800</p>
          </div>
        </div>
      </div>
    );
